...
//       {/* Glass folder shell */}
//       <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[30px] border border-white/40 bg-white/25">
//         {/* Top bar */}
//         <div className="flex h-14 shrink-0 items-end gap-2 overflow-x-auto bg-white/20 px-4">
...
//                 className={`h-14 min-w-40 rounded-t-[24px] px-7 text-sm font-bold ${
//                   isActive
//                     ? "bg-white/35 text-black shadow-lg"
//                     : "bg-white/15 text-black/55 hover:bg-white/25 hover:text-black"
//                 }`}
//               >
//                 {student.name}
//               </button>
...
//         {/* Glass folder body */}
//         <main className="min-h-0 flex-1 overflow-y-auto bg-white/35 p-6 backdrop-blur-xl">
...
//                   <article
//                     key={lesson.id}
//                     className="rounded-[22px] border border-black/10 bg-white/60 p-5 shadow-sm hover:bg-white/75 hover:shadow-lg"
//                   >
